Реализуйте задачи в Java, подбирая нужные конструкции.
...
1. Зоопарк
   ...
   Нужно спроектировать систему, которая может работать с любым животным, добавлять его в зоопарк и демонстрировать его
   поведение.
